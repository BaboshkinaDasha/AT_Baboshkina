...
namespace TestWebDriverAdvanced
{
    ...
    public class TestAdvanced
    {
        ...
        public void Test3_CheckProduct()
        {
            ...
            page_allproducts.ToEditProduct("Fanta");
        ...
        {
            page_homepage.ToAllProducts();
            page_allproducts.ToRemoveProduct("Fanta");
            Assert.IsFalse(page_allproducts.ProductIsRemove("Fanta"));
        }
        ...
        public void Test5_Logout()
        {
            ...
            Assert.IsTrue(page_login.ToFindLogin("Login"));
        }
